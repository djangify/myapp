# Generated manually to match current models.py
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("files", models.FileField(upload_to="products/files/", null=True, blank=True, storage=storage.secure_storage, help_text="Upload a PDF or ZIP file. Use ZIP for bundles.")),
                ("preview_file", models.FileField(upload_to="products/previews/", null=True, blank=True, storage=storage.public_storage)),
                ("preview_image", models.ImageField(upload_to="products/images/", null=True, blank=True, storage=storage.public_storage)),
                ("video_url", models.URLField(blank=True, null=True, help_text="Optional YouTube or Vimeo URL to display on the product page")),
                ("video_file", models.FileField(upload_to="products/videos/", null=True, blank=True, storage=storage.public_storage, help_text="Upload a short MP4 file to display as product video")),
