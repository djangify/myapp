    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('files', models.FileField(blank=True, null=True, storage=inspirational.storage.SecureFileStorage(), upload_to='products/files/')),
                ('preview_file', models.FileField(blank=True, null=True, storage=inspirational.storage.PublicMediaStorage(), upload_to='products/previews/')),
                ('preview_image', models.ImageField(blank=True, null=True, storage=inspirational.storage.PublicMediaStorage(), upload_to='products/images/')),
